...
public class SubmitClaimsSpec {

	private final static int RECEIPT_VALIDITY_PERIOD_IN_DAYS = 28;

	public SubmitClaimsSpec() {

	}

	CompositeSpecification<MedicalClaims> consultationDateSpec = new CompositeSpecification<MedicalClaims>() {
