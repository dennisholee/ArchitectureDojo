package io.forest.jhipsterdemo.web.rest;

import static org.springframework.web.servlet.mvc.method.annotation.SseEmitter.event;

import io.forest.jhipsterdemo.config.KafkaSseConsumer;
import io.forest.jhipsterdemo.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/jhipsterdemo-kafka")
public class JhipsterdemoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterdemoKafkaResource.class);
    ...
    public JhipsterdemoKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
